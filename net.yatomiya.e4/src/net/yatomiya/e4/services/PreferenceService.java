...
public class PreferenceService {
    class ListenerBundle {
        ...
        public void subscribe(Object tag, String node, String key, Listener listener) {
            ...
            if (nodeListener == null) {
                ...
                getEclipsePreferences(node).addPreferenceChangeListener(nodeListener);
            }
            ...
            for (Entry e : tagMap.get(tag)) {
                ...
                if (list.size() == 0) {
                    ...
                    if (nodeListener.keyMap.size() == 0) {
                        ...
                        getEclipsePreferences(e.node).removePreferenceChangeListener(nodeListener);
                    }
                }
            }
            tagMap.remove(tag);
    ...
    IEclipsePreferences getEclipsePreferences(String node) {
    ...
    public void subscribe(Object tag, String node, String key, Listener listener) {
        ...
        IEclipsePreferences prefs = getEclipsePreferences(node);
        // IEclipsePreferences.get() returns only local value, does not search default value.
        Object value = getString(node, key);

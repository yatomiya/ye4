...
public class StringUtils {
    ...
    static Transliterator halfToFullTrans;

    public static String halfToFull(String s) {
        if (halfToFullTrans == null)
            halfToFullTrans = Transliterator.getInstance("Halfwidth-Fullwidth");
        return halfToFullTrans.transliterate(s);
    }

    static Transliterator fullToHalfTrans;

    // "Fullwidth-Halfwidth" decomposes dakuten kana to kana + dakuten,
    // length of return value is not identical to arg.
    public static String fullToHalf(String s) {

        if (fullToHalfTrans == null)
            fullToHalfTrans = Transliterator.getInstance("Fullwidth-Halfwidth");
        String t = fullToHalfTrans.transliterate(s);
        return t;
    }
}

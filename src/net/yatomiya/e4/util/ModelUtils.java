...
public class ModelUtils {
    ...
    public static EModelService getService() {
        return AppUtils.get(EModelService.class);
    }
    ...
    public static MApplication getApplication() {
        return AppUtils.get(MApplication.class);
    }
    ...
    public static MPart getActivePart() {
        return (MPart)AppUtils.get(IServiceConstants.ACTIVE_PART);
    }
    ...
    public static MWindow getActiveWindow() {
        Shell activeShell = (Shell)AppUtils.get(IServiceConstants.ACTIVE_SHELL);

...
public class PartService {
    public static final String PART_UUID_KEY = PartService.class.getName() + ":PART_UUID_KEY";
    ...
    public static final String PART_CONTAINER_TYPE_DEFAULT = PART_CONTAINER_TYPE + ".default";
    ...
    public void initialize(IEclipseContext context) {
        ...
        context.get(EventService.class).subscribe(
            this,
            UIEvents.UIElement.TOPIC_WIDGET,
            new EventService.Handler() {
                @Override
                public void handleEvent(EventService.Event event) {
                    EventService.UIEventData data = (EventService.UIEventData)event.getData();
    ...
    public MPart getActivePart() {
        return ModelUtils.getActivePart();
    }
    ...
    public MPart openPart(String descId, boolean showIfExists, PartState state, String containerType) {
        MPart part = null;
        MPartDescriptor desc = ModelUtils.getPartDescriptor(descId);

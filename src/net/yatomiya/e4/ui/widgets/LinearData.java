 ...
 * @since 3.0
 */
public LinearData (int horizontalAlignment, int verticalAlignment, boolean grabExcessHorizontalSpace, boolean grabExcessVerticalSpace) {
 ...
 * @since 3.0
 */
public LinearData (int horizontalAlignment, int verticalAlignment, boolean grabExcessHorizontalSpace, boolean grabExcessVerticalSpace, int horizontalSpan, int verticalSpan) {
	super ();
 ...
 * @since 3.0
 */
public LinearData (int width, int height) {
	super ();
...
public String toString () {
	...
	switch (horizontalAlignment) {
		...
		case END: hAlign = "LinearData.END"; break;
		case SWT.RIGHT: hAlign = "SWT.RIGHT"; break;
		case SWT.CENTER: hAlign = "SWT.CENTER"; break;
		case CENTER: hAlign = "LinearData.CENTER"; break;
	...
	switch (verticalAlignment) {
		...
		case END: vAlign = "LinearData.END"; break;
		case SWT.BOTTOM: vAlign = "SWT.BOTTOM"; break;
		case SWT.CENTER: vAlign = "SWT.CENTER"; break;
		case CENTER: vAlign = "LinearData.CENTER"; break;
    ...
    public static LinearData create(int horizontalAlignment, int verticalAlignment) {
        return new LinearData(horizontalAlignment, verticalAlignment, false, false);
    }

    public static LinearData createFill() {
        return new LinearData(SWT.FILL, SWT.FILL, true, true);
    }

    public static LinearData createHFill(int verticalAlignment) {
        return new LinearData(SWT.FILL, verticalAlignment, true, false);
    }

    public static LinearData createVFill(int horizontalAlignment) {
        return new LinearData(horizontalAlignment, SWT.FILL, false, true);
    }

    public static LinearData createExclude() {
        LinearData d = new LinearData();
        d.exclude = true;
        return d;
    }
}

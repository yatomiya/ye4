 ...
 *******************************************************************************/
package net.yatomiya.e4.ui.internal.workbench.renderers.swt;
...
public class SWTRenderersMessages extends NLS {
	private static final String BUNDLE_NAME = "net.yatomiya.e4.ui.internal.workbench.renderers.swt.messages"; //$NON-NLS-1$
